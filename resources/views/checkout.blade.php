        ...
        <div class="row"> 
            <div class="col-lg-8 col-12">
                <div class="checkout-form">
                    ...
                    <!-- Form -->
                    <form id="checkout-form" class="form" method="post" action="{{ route('checkout.store') }}">
                        @csrf
                        <div class="row">
            ...
            <div class="col-lg-4 col-12">
                <div class="order-details">
                    ...
                    <div class="single-widget">
                        ...
                        <div class="content">
                            <ul>
                                <li>Subtotal<span>${{ priceFormat($numbers['subtotal']) }}</span></li>
                                <li>Tax(9%)<span>${{ priceFormat($numbers['tax']) }}</span></li>
                                <li>(+) Shipping<span>$10.00</span></li>
                                <li class="last">Total<span>${{ priceFormat($numbers['total'] + 10) }}</span></li>
                            </ul>
                        </div>
                    </div>
                    <!--/ End Order Widget -->
                    ...
                    <div class="single-widget">
                        ...
                        <div class="content">
                            <div class="checkbox">
                                <label class="checkbox-inline" for="1"><input name="payment" id="1" type="radio"> Check Payments</label>
                    ...
                    <div class="single-widget get-button">
                        <div class="content">
                            <div class="button">
                                <a onclick="document.getElementById('checkout-form').submit();" class="btn">proceed to checkout</a>
                            </div>
                        </div>
                    </div>
                    <!--/ End Button Widget -->
